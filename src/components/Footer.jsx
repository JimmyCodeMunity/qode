                ...
                <div class="mx-auto md:px-16 px-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                            ...
                            </a><h1 className="font-poppins text-4xl font-bold bg-gradient-to-r from-blue-600 via-lime-500 to-orange-500 bg-clip-text text-transparent">Qode</h1>
                            ...
                            <a href="javascript:;" class="py-2.5 px-5 h-9 block w-fit bg-lime-500 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-lime-500 lg:mx-0">
                                Contact us
                            </a>
                        </div>
                        ...
                        <div class="lg:mx-auto text-left ">
                            ...
                            <ul class="text-sm  transition-all duration-500">
                                ...
                                <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Mobile Development</a></li>
                                <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Web Development</a></li>
                                <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Programming classes</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="lg:mx-auto text-left ">
                            ...
                            <a href="javascript:;" class="flex items-center justify-center gap-2 border border-lime-600 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-lime-500 font-semibold transition-all duration-500 hover:bg-indigo-50">Subscribe<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.25 6L13.25 6M9.5 10.5L13.4697 6.53033C13.7197 6.28033 13.8447 6.15533 13.8447 6C13.8447 5.84467 13.7197 5.71967 13.4697 5.46967L9.5 1.5" stroke="#78E546FF" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="py-7 border-t border-gray-200">
                        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                            <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">qode</a> 2025, All rights reserved.</span>
